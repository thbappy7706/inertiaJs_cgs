(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_admin_crm_form_Create_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/FormFieldEditor.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/FormFieldEditor.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _form_fields_FormField__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./form_fields/FormField */ "./resources/js/components/admin/crm/forms/form_fields/FormField.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    FormField: _form_fields_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  model: {
    prop: 'formFields'
  },
  ...
  computed: {
    selectedFormFieldTypes: function selectedFormFieldTypes() {
      var types = new Set();

      lodash__WEBPACK_IMPORTED_MODULE_0___default().forEach(this.editableFormFields, function (field) {
        if (field.type) {
    ...
    selectableFormFieldTypes: function selectableFormFieldTypes() {
      var _this = this;

      // CRM fields can only be selected once
      var availableCrmTypes = {};

      lodash__WEBPACK_IMPORTED_MODULE_0___default().forEach(this.crmFormFieldTypes, function (label, slug) {
        if (!_this.selectedFormFieldTypes.has(slug)) {
          availableCrmTypes[slug] = label;
        }
      });

      return _objectSpread(_objectSpread({}, availableCrmTypes), this.standardFormFieldTypes);
    }
  },
  created: function created() {
    ...
    this.editableFormFields = lodash__WEBPACK_IMPORTED_MODULE_0___default().cloneDeep(this.formFields);
  },
  methods: {
    ...
    deleteFormField: function deleteFormField(index) {
      try {
    ...
    onFormFieldsChange: function onFormFieldsChange(fields) {
      this.editableFormFields = lodash__WEBPACK_IMPORTED_MODULE_0___default().cloneDeep(fields);
    },
    reorderFormFields: function reorderFormFields() {
      var _this2 = this;
      ...
      try {
        ...
        this.editableFormFields.forEach(function (field, index) {
          _this2.editableFormFields[index].order = index;
        });
        this.updateFormFields();
      } catch (e) {
    ...
    updateFormFields: function updateFormFields() {
      this.$emit('input', lodash__WEBPACK_IMPORTED_MODULE_0___default().cloneDeep(this.editableFormFields));
    }
  },
  watch: {
    formFields: {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/FormField.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/FormField.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _form_field_settings_NumberSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form_field_settings/NumberSettings */ "./resources/js/components/admin/crm/forms/form_fields/form_field_settings/NumberSettings.vue");
...
/* harmony import */ var _form_field_settings_TextAreaSettings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form_field_settings/TextAreaSettings */ "./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextAreaSettings.vue");
/* harmony import */ var _form_field_settings_TextSettings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./form_field_settings/TextSettings */ "./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextSettings.vue");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    NumberSettings: _form_field_settings_NumberSettings__WEBPACK_IMPORTED_MODULE_3__["default"],
    SelectGroup: _core_forms_SelectGroup__WEBPACK_IMPORTED_MODULE_4__["default"],
    TextAreaSettings: _form_field_settings_TextAreaSettings__WEBPACK_IMPORTED_MODULE_5__["default"],
    TextSettings: _form_field_settings_TextSettings__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  model: {
    prop: 'formField'
  },
  ...
  computed: {
    defaultFieldSettings: function defaultFieldSettings() {
    ...
    errorMessageKey: function errorMessageKey() {
      return this.errorMessageKeyPrefix + '.' + this.editableFormField.order + '.';
    },
    isCrmFieldType: function isCrmFieldType() {
      try {
    ...
    selectableFormFieldTypes: function selectableFormFieldTypes() {
      var types = {}; // Add the currently selected type if it's a CRM type

      if (this.isCrmFieldType) {
        types[this.editableFormField.type] = this.crmFormFieldTypes[this.editableFormField.type];
      }

      types = _objectSpread(_objectSpread({}, types), this.formFieldTypes);
      return types;
    },
  ...
  created: function created() {
    this.editableFormField = _.cloneDeep(this.formField); // If there is an existing slug, disable the auto slug update
  ...
  methods: {
    clearErrorMessage: function clearErrorMessage(field) {
      this.clearPageErrorMessage(this.errorMessageKey + field);
    },
    getErrorMessage: function getErrorMessage(field) {
      var message = this.getPageErrorMessage(this.errorMessageKey + field);
      message = message.replace(this.errorMessageKey, '');
      return message;
    },
    onEditableFormFieldUpdate: function onEditableFormFieldUpdate() {
      if (this.isCrmFieldType) {
        // Use the type as slug for CRM fields
        this.$set(this.editableFormField, 'slug', this.editableFormField.type);
      }
    },
    ...
    updateFormField: function updateFormField() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/NumberSettings.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/NumberSettings.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _mixins_admin_crm_form_field_settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../../mixins/admin/crm/form-field-settings */ "./resources/js/mixins/admin/crm/form-field-settings.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "FormFieldNumberSettings",
  mixins: [_mixins_admin_crm_form_field_settings__WEBPACK_IMPORTED_MODULE_0__.formFieldSettingsMixin],
  components: {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextAreaSettings.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextAreaSettings.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextSettings.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextSettings.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/core/forms/ArrayGroup..vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/core/forms/ArrayGroup..vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _mixins_admin_cms_forms_base_form_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../mixins/admin/cms/forms/base-form-group */ "./resources/js/mixins/admin/cms/forms/base-form-group.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "ArrayGroup",
  mixins: [_mixins_admin_cms_forms_base_form_group__WEBPACK_IMPORTED_MODULE_1__.baseFormGroupMixin],
  components: {
  ...
  mounted: function mounted() {
    try {
      if (Array.isArray(this.inputValue)) {
        this.editableInputValue = lodash__WEBPACK_IMPORTED_MODULE_0___default().clone(this.inputValue);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/crm/form/Create.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/crm/form/Create.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var slugify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! slugify */ "./node_modules/slugify/slugify.js");
/* harmony import */ var slugify__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(slugify__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_core_forms_ArrayGroup___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../components/core/forms/ArrayGroup. */ "./resources/js/components/core/forms/ArrayGroup..vue");
/* harmony import */ var _components_admin_crm_forms_FormFieldEditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../components/admin/crm/forms/FormFieldEditor */ "./resources/js/components/admin/crm/forms/FormFieldEditor.vue");
/* harmony import */ var _components_core_forms_InlineCheckboxGroup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../components/core/forms/InlineCheckboxGroup */ "./resources/js/components/core/forms/InlineCheckboxGroup.vue");
...
/* harmony import */ var _components_core_forms_TextAreaGroup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../components/core/forms/TextAreaGroup */ "./resources/js/components/core/forms/TextAreaGroup.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ArrayGroup: _components_core_forms_ArrayGroup___WEBPACK_IMPORTED_MODULE_1__["default"],
    FormFieldEditor: _components_admin_crm_forms_FormFieldEditor__WEBPACK_IMPORTED_MODULE_2__["default"],
    InlineCheckboxGroup: _components_core_forms_InlineCheckboxGroup__WEBPACK_IMPORTED_MODULE_3__["default"],
    InputGroup: _components_core_forms_InputGroup__WEBPACK_IMPORTED_MODULE_4__["default"],
    TextAreaGroup: _components_core_forms_TextAreaGroup__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  layout: 'admin-layout',
  props: {
    crmFormFieldTypes: {
  ...
  methods: {
    ...
    submit: function submit() {
      this.$inertia.post(this.$route('admin.crm.forms.store'), this.formData);
    }
  }
});
...
/***/ "./resources/js/mixins/admin/crm/form-field-settings.js":
/*!**************************************************************!*\
  !*** ./resources/js/mixins/admin/crm/form-field-settings.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formFieldSettingsMixin": () => (/* binding */ formFieldSettingsMixin)
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);

var formFieldSettingsMixin = {
  model: {
    prop: 'fieldSettings'
  },
  props: {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/FormFieldEditor.vue?vue&type=style&index=0&id=dbfb3a12&scoped=true&lang=css&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/FormFieldEditor.vue?vue&type=style&index=0&id=dbfb3a12&scoped=true&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.ghost[data-v-dbfb3a12] {\n    opacity: 0.35;\n}\n.flip-field-move[data-v-dbfb3a12] {\n    transition: transform 0.5s;\n}\n.no-move[data-v-dbfb3a12] {\n    transition: transform 0s;\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_11_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_11_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FormFieldEditor_vue_vue_type_style_index_0_id_dbfb3a12_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./FormFieldEditor.vue?vue&type=style&index=0&id=dbfb3a12&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-11[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/FormFieldEditor.vue?vue&type=style&index=0&id=dbfb3a12&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_11_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_11_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FormFieldEditor_vue_vue_type_style_index_0_id_dbfb3a12_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/admin/crm/forms/FormFieldEditor.vue":
/*!*********************************************************************!*\
  !*** ./resources/js/components/admin/crm/forms
                    ...
                    [
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            [
                              formField.name && formField.name.length
                                ? [
                                    _vm._v(
                                      "\n                            " +
                      ...
                      _c(
                        ...
                        [
                          _c("form-field", {
                            attrs: {
                              "crm-form-field-types": _vm.crmFormFieldTypes,
                              "form-field-types": _vm.selectableFormFieldTypes,
                              "form-field-settings": _vm.formFieldSettings,
                              "is-autofocus-disabled": _vm.isAutofocusDisabled,
                            },
                            on: { input: _vm.updateFormFields },
                            model: {
                              value: _vm.editableFormFields[index],
                              callback: function ($$v) {
                                _vm.$set(_vm.editableFormFields, index, $$v)
                              },
                              expression: "editableFormFields[index]",
                            },
                          }),
                        ],
                        1
                            ...
                            "button",
                            {
                              ...
                              on: {
                                click: function ($event) {
                                  return _vm.deleteFormField(index)
                                },
                              },
                            },
                            [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "flex flex-row items-center mt-6" }, [
        _c(
          "button",
          {
            staticClass:
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/FormField.vue?vue&type=template&id=4e9e49a2&":
/*!*************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/FormField.vue?vue&type=template&id=4e9e49a2& ***!
  \*************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    ...
    [
        ...
        [
          _c("select-group", {
            ...
            attrs: {
              ...
              "input-autofocus": !_vm.isAutofocusDisabled,
              "input-id": "form-field-" + _vm.formField.order + "-type",
              "input-name": "form-field-" + _vm.formField.order + "-type",
              "input-options": _vm.selectableFormFieldTypes,
              "input-required": true,
            },
            on: {
              errorHidden: function ($event) {
                return _vm.clearErrorMessage("type")
              },
              input: _vm.updateFormField,
            },
            model: {
              value: _vm.editableFormField.type,
              callback: function ($$v) {
                _vm.$set(_vm.editableFormField, "type", $$v)
              },
              expression: "editableFormField.type",
            },
          }),
          _vm._v(" "),
          _c("input-group", {
            ...
            attrs: {
              "input-disabled": true,
              "input-id": "form-field-" + _vm.formField.order + "-order",
              "input-name": "form-field-" + _vm.formField.order + "-order",
              "input-type": "number",
              "label-text": "Order",
            },
            on: { input: _vm.updateFormField },
            model: {
              value: _vm.editableFormField.order,
              callback: function ($$v) {
                _vm.$set(_vm.editableFormField, "order", $$v)
              },
              expression: "editableFormField.order",
            },
          }),
        ],
        1
        ...
        [
          _c("input-group", {
            ...
            attrs: {
              ...
              "input-id": "template-field-" + _vm.formField.order + "-name",
              "input-name": "template-field-" + _vm.formField.order + "-name",
              "input-required": true,
              "input-type": "text",
            ...
            on: {
              errorHidden: function ($event) {
                return _vm.clearErrorMessage("name")
              },
              input: _vm.onNameInput,
            },
            model: {
              value: _vm.editableFormField.name,
              callback: function ($$v) {
                _vm.$set(_vm.editableFormField, "name", $$v)
              },
          ...
          _c("input-group", {
            ...
            attrs: {
              ...
              "input-disabled": _vm.isCrmFieldType,
              "input-id": "template-field-" + _vm.formField.order + "-slug",
              "input-name": "template-field-" + _vm.formField.order + "-slug",
              "input-required": true,
              "input-type": "text",
            ...
            model: {
              value: _vm.editableFormField.slug,
              callback: function ($$v) {
                _vm.$set(_vm.editableFormField, "slug", $$v)
              },
              expression: "editableFormField.slug",
            },
          }),
        ],
        1
      ...
      _c("checkbox-group", {
        staticClass: "mt-4",
        attrs: {
          "input-id": "template-field-" + _vm.formField.order + "-is_required",
          "input-name":
            "template-field-" + _vm.formField.order + "-is_required",
          "error-message": _vm.getErrorMessage("is_required"),
          "label-text": "Required?",
        },
        on: { input: _vm.updateFormField },
        model: {
          value: _vm.editableFormField.is_required,
          callback: function ($$v) {
            _vm.$set(_vm.editableFormField, "is_required", $$v)
          },
          expression: "editableFormField.is_required",
        },
      }),
      _vm._v(" "),
      _vm.settingsComponent
        ? _c(
            _vm.settingsComponent,
            {
              tag: "component",
              attrs: {
                "default-settings": _vm.defaultFieldSettings,
                "form-field": _vm.editableFormField,
              },
              on: { input: _vm.updateFormField },
              model: {
                value: _vm.editableFormField.settings,
                callback: function ($$v) {
                  _vm.$set(_vm.editableFormField, "settings", $$v)
                },
                expression: "editableFormField.settings",
              },
            },
            [
              _c(
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/NumberSettings.vue?vue&type=template&id=4ffa382f&":
/*!**************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/NumberSettings.vue?vue&type=template&id=4ffa382f& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      _c(
        ...
        [
          _c("input-group", {
            staticClass: "flex-1 mt-4",
            attrs: {
              "input-id": "form-field-" + _vm.formField.order + "-min",
              "input-name": "form-field-" + _vm.formField.order + "-min",
              "input-type": "number",
          ...
          _c("input-group", {
            staticClass: "flex-1 mt-4",
            attrs: {
              "input-id": "form-field-" + _vm.formField.order + "-max",
              "input-name": "form-field-" + _vm.formField.order + "-max",
              "input-type": "number",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextAreaSettings.vue?vue&type=template&id=77384000&":
/*!****************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextAreaSettings.vue?vue&type=template&id=77384000& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    ...
    [
      ...
      _c("input-group", {
        staticClass: "flex-1 mt-4",
        attrs: {
          "input-id": "form-field-" + _vm.formField.order + "-max-length",
          "input-name": "form-field-" + _vm.formField.order + "-max-length",
          "input-type": "number",
      ...
      _c("input-group", {
        staticClass: "flex-1 mt-4",
        attrs: {
          "input-id": "form-field-" + _vm.formField.order + "-rows",
          "input-name": "form-field-" + _vm.formField.order + "-rows",
          "input-type": "text",
          "label-text": "Rows",
        },
        on: { input: _vm.onEditableSettingsChange },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextSettings.vue?vue&type=template&id=da2e9a5a&":
/*!************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/admin/crm/forms/form_fields/form_field_settings/TextSettings.vue?vue&type=template&id=da2e9a5a& ***!
  \************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/core/forms/ArrayGroup..vue?vue&type=template&id=94ccc63a&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/core/forms/ArrayGroup..vue?vue&type=template&id=94ccc63a& ***!
  \**********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", [
        _c("div", { class: _vm.inputWrapperClass }, [
        ...
        _vm._v(" "),
        _vm.editableInputValue.length
          ? _c(
              "div",
              { class: _vm.inputValuesWrapperClass },
              _vm._l(_vm.editableInputValue, function (value, index) {
                return _c(
                  "button",
                  {
                    key: "value-" + index + "-" + value,
                    class: _vm.inputValuesClass,
                    attrs: { type: "button" },
                    on: {
                      click: function ($event) {
                  ...
                  [
                    ...
                    _c("icon-x", { class: _vm.inputValuesCloseClass }),
                  ],
                  1
                )
              }),
        ...
        change: [
          function ($event) {
            var $$a = _vm.editableValue,
              $$el = $event.target,
              $$c = $$el.checked ? _vm.inputValueTrue : _vm.inputDisabled
            if (Array.isArray($$a)) {
              var $$v = null,
                $$i = _vm._i($$a, $$v)
              if ($$el.checked) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/crm/form/Create.vue?vue&type=template&id=12efe286&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/crm/form/Create.vue?vue&type=template&id=12efe286& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm.userCan("crm_forms.view")
            ? _c(
                "inertia-link",
                {
                  staticClass:
                    "\n                button button-default-responsive button-primary-subtle\n                flex flex-row items-center mr-2\n            ",
                  attrs: { href: _vm.$route("admin.crm.forms.index") },
                },
                [
        ...
        _c(
          ...
          [
            ...
            _c("text-area-group", {
              staticClass: "mt-4",
              attrs: {
                "error-message": _vm.getPageErrorMessage("success_message"),
              ...
              on: {
                errorHidden: function ($event) {
                  return _vm.clearPageErrorMessage("success_message")
                },
              },
              model: {
                value: _vm.formData.success_message,
                callback: function ($$v) {
                  _vm.$set(_vm.formData, "success_message", $$v)
                },
                expression: "formData.success_message",
              },
            }),
            _vm._v(" "),
            _c("input-group", {
              staticClass: "mt-4",
              attrs: {
                "error-message": _vm.getPageErrorMessage("redirect_url"),
              ...
              on: {
                errorHidden: function ($event) {
                  return _vm.clearPageErrorMessage("redirect_url")
                },
              },
              model: {
                value: _vm.formData.redirect_url,
                callback: function ($$v) {
                  _vm.$set(_vm.formData, "redirect_url", $$v)
                },
                expression: "formData.redirect_url",
              },
            }),
            _vm._v(" "),
            _c("array-group", {
              ...
              attrs: {
                "error-message":
                  _vm.getPageErrorMessageFromArrayField("email_recipients"),
                "input-id": "email_recipients",
                "input-name": "email_recipients",
                "label-text": "Email Recipients",
              },
              model: {
                value: _vm.formData.email_recipients,
                callback: function ($$v) {
                  _vm.$set(_vm.formData, "email_recipients", $$v)
                },
                expression: "formData.email_recipients",
              },
            }),
          ],
          1
            ...
            _c(
              ...
              [
                _c("inline-checkbox-group", {
                  ...
                  model: {
                    value: _vm.formData.marketing_email,
                    callback: function ($$v) {
                      _vm.$set(_vm.formData, "marketing_email", $$v)
                    },
                    expression: "formData.marketing_email",
                  },
                }),
                _vm._v(" "),
                _c("inline-checkbox-group", {
                  ...
                  model: {
                    value: _vm.formData.marketing_sms,
                    callback: function ($$v) {
                      _vm.$set(_vm.formData, "marketing_sms", $$v)
                    },
                    expression: "formData.marketing_sms",
                  },
                }),
                _vm._v(" "),
                _c("inline-checkbox-group", {
                  ...
                  model: {
                    value: _vm.formData.marketing_telephone,
                    callback: function ($$v) {
                      _vm.$set(_vm.formData, "marketing_telephone", $$v)
                    },
                    expression: "formData.marketing_telephone",
                  },
                }),
              ],
              1
      ...
      _c(
        ...
        [
          _c(
            ...
            { staticClass: "block px-6 w-full" },
            [
              _c("form-field-editor", {
                attrs: {
                  "crm-form-field-types": _vm.crmFormFieldTypes,
                  "form-field-settings": _vm.formFieldSettings,
                  "standard-form-field-types": _vm.standardFormFieldTypes,
                },
                model: {
                  value: _vm.formData.form_fields,
                  callback: function ($$v) {
                    _vm.$set(_vm.formData, "form_fields", $$v)
                  },
                  expression: "formData.form_fields",
                },
              }),
            ],
            1
